...
class CLI(object):
    ...
    def version(self, args=None):
        sys.stdout.write(add_linesep_if_missing(perfecthash.__version__))
        return self._exit(0)
...
if __name__ == '__main__':
    # Intended invocation:
    #   python -m perfecthash.cli <program_name> <library_name> \
...
def main(program_name=None, library_name=None):
    if not program_name:
        program_name = 'perfecthash'
    if not library_name:
        library_name = 'perfecthash'
