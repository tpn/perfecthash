...
typedef PERFECT_HASH_TABLE_SEEDED_HASH16_EX
      *PPERFECT_HASH_TABLE_SEEDED_HASH16_EX;

typedef
ULONGLONG
(STDAPICALLTYPE PERFECT_HASH_TABLE_SEEDED_HASH64_EX)(
    _In_ ULONGLONG Key,
    _In_ PULONGLONG Seeds,
    _In_ ULONGLONG Mask
    );
typedef PERFECT_HASH_TABLE_SEEDED_HASH64
      *PPERFECT_HASH_TABLE_SEEDED_HASH64_EX;
...
typedef struct _PERFECT_HASH_TABLE_VTBL {
    ...
    PPERFECT_HASH_TABLE_SEEDED_HASH64_EX SeededHash64Ex;
