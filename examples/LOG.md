...
- 2026-02-27: Added slim public online/rawdog header `include/PerfectHash/PerfectHashOnlineRawdog.h` and wrapper implementation `src/PerfectHash/PerfectHashOnlineRawdog.c`.
