...
cmake -S . -B build \
  ...
  -DPERFECTHASH_BUILD_PROFILE=online-rawdog
...
- `online-rawdog`: online/rawdog libraries without LLVM and without CLI exes.
- `online-rawdog-llvm`: online/rawdog plus LLVM support.
