...
if(DEFINED REQUIRE_GPU_ORDER_VALID AND REQUIRE_GPU_ORDER_VALID)
  string(FIND "${stderr}" "[GraphCuIsAcyclic] GpuOrderValidationResult=0x00000000" gpu_order_valid_index)
  if(gpu_order_valid_index EQUAL -1)
    message(FATAL_ERROR "Expected GPU order validation success log, but it was not present.")
  endif()
endif()

if(DEFINED REQUIRE_GPU_VERIFY AND REQUIRE_GPU_VERIFY)
  string(FIND "${stderr}" "[GraphCuVerify] GpuVerifyResult=0x00000000" gpu_verify_index)
  if(gpu_verify_index EQUAL -1)
    message(FATAL_ERROR "Expected GPU verify success log, but it was not present.")
  endif()

  string(FIND "${stderr}" "[GraphCuVerify] CpuVerifyResult=" cpu_verify_index)
  if(NOT cpu_verify_index EQUAL -1)
    message(FATAL_ERROR "Expected GPU verify path without CPU verify fallback, but CPU verify log was present.")
  endif()
endif()
