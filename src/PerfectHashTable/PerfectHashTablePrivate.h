...
#define PH_E_CONTEXT_SELF_TEST_INVALID_NUM_ARGS E_UNEXPECTED
#define PH_E_INVALID_MAXIMUM_CONCURRENCY E_UNEXPECTED
#define PH_E_SET_MAXIMUM_CONCURRENCY_FAILED E_UNEXPECTED
