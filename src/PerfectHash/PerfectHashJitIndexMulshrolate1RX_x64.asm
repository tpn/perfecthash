        title "Perfect Hash RawDog Mulshrolate1RX x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RX_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate1RX Index() routine for 32-bit
...
;
; ULONG
; PerfectHashJitIndexMulshrolate1RX_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RX_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RX_x64, _TEXT$00
