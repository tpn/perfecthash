        title "Perfect Hash RawDog MultiplyShiftRX Index32x16 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRXIndex32x16_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftRX Index32x16() routine as a
...
;
; VOID
; PerfectHashJitIndexMultiplyShiftRXIndex32x16_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
; Routine Description:
;
;   This routine implements the MultiplyShiftRX index functionality for sixteen
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRXIndex32x16_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRXIndex32x16_x64, _TEXT$00
