...
Abstract:
    ...
    test exe C source file as part of the CHM v1 algorithm implementation
...
#include "CompiledPerfectHashTableTestExe_CSource_RawCString.h"

_Use_decl_annotations_
HRESULT
PrepareCSourceTestExeFileChm01(
