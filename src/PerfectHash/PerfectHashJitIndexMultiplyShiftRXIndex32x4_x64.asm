        title "Perfect Hash RawDog MultiplyShiftRX Index32x4 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRXIndex32x4_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftRX Index32x4() routine as a
...
;
; VOID
; PerfectHashJitIndexMultiplyShiftRXIndex32x4_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRXIndex32x4_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRXIndex32x4_x64, _TEXT$00
