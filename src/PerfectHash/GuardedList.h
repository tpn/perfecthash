...
typedef
VOID
(STDAPICALLTYPE GUARDED_LIST_RESET)(
    _In_ PGUARDED_LIST List
    );
typedef GUARDED_LIST_RESET *PGUARDED_LIST_RESET;
...
(NTAPI GUARDED_LIST_RUNDOWN)(
    _In_ _Post_ptr_invalid_ PGUARDED_LIST List
    );
...
extern GUARDED_LIST_RESET GuardedListReset;
