        title "Perfect Hash RawDog Mulshrolate3RX Avx2 v2 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate3RXAvx2_v2_x64.asm
;
; Abstract:
;
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate3RXAvx2_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate3RXAvx2_x64, _TEXT$00
