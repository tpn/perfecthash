        title "Perfect Hash RawDog MultiplyShiftR16 Index32x8 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftR16Index32x8_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftR Index32x8() routine for 16-bit
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftR16Index32x8_x64, _TEXT$00, NoPad
        ...
        vpsrld  ymm4, ymm4, xmm2

        mov     rax, 0F1F1F1F1F1F1F1F1h             ; Hash mask.
        vmovd   xmm1, eax
        vpbroadcastd ymm5, xmm1

        vpand   ymm3, ymm3, ymm5                   ; Mask vertex1.
        vpand   ymm4, ymm4, ymm5                   ; Mask vertex2.
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftR16Index32x8_x64, _TEXT$00
