...
// Module Name:
//
//   PerfectHashJitIndexMultiplyShiftRX_arm64.s
//
// Abstract:
//
//   This module implements the MultiplyShiftRX Index() routine as a position-
...
//--
        ...
        .globl PerfectHashJitIndexMultiplyShiftRX_arm64

//+++
//
// ULONG
// PerfectHashJitIndexMultiplyShiftRX_arm64(
//     _In_ ULONG Key
//     );
//
// Routine Description:
//
//   This routine implements the MultiplyShiftRX index functionality.  It is
...
PerfectHashJitIndexMultiplyShiftRX_arm64:
        ...
        ldr     w3, RawDogSeed3Byte1
        lsrv    w1, w1, w3                    // Vertex1 >>= Seed3_Byte1.

        mov     w2, w0                        // Copy key into w2.
        ldr     w4, RawDogSeed2               // Load seed2.
        mul     w2, w2, w4                    // Vertex2 = Key * Seed2.
        lsrv    w2, w2, w3                    // Vertex2 >>= Seed3_Byte1.

        ldr     w1, [x10, w1, uxtw #2]        // Load vertex1.
        ldr     w2, [x10, w2, uxtw #2]        // Load vertex2.
