        title "Perfect Hash RawDog Mulshrolate2RX Index32x4 Avx2 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate2RXIndex32x4Avx2_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate2RX Index32x4() routine using AVX2
...
;
; VOID
; PerfectHashJitIndexMulshrolate2RXIndex32x4Avx2_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate2RXIndex32x4Avx2_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate2RXIndex32x4Avx2_x64, _TEXT$00
