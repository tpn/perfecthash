        title "Perfect Hash RawDog Mulshrolate1RX Index32x4 Avx2 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RXIndex32x4Avx2_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate1RX Index32x4() routine using AVX2
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RXIndex32x4Avx2_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RXIndex32x4Avx2_x64, _TEXT$00
