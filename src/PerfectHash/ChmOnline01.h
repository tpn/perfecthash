...
typedef
VOID
(NTAPI PERFECT_HASH_TABLE_HASH_JIT_RUNDOWN)(
    _Inout_ PPERFECT_HASH_TABLE Table
    );
typedef PERFECT_HASH_TABLE_HASH_JIT_RUNDOWN
      *PPERFECT_HASH_TABLE_HASH_JIT_RUNDOWN;

typedef
_Must_inspect_result_
_Success_(return >= 0)
HRESULT
(NTAPI PERFECT_HASH_TABLE_COMPILE_HASH_JIT)(
    _In_ PPERFECT_HASH_TABLE Table,
    _In_opt_ PPERFECT_HASH_TABLE_COMPILE_FLAGS CompileFlags
    );
typedef PERFECT_HASH_TABLE_COMPILE_HASH_JIT
      *PPERFECT_HASH_TABLE_COMPILE_HASH_JIT;
...
extern PERFECT_HASH_TABLE_COMPILE_HASH_JIT PerfectHashTableCompileHashJit;
extern PERFECT_HASH_TABLE_HASH_JIT_RUNDOWN PerfectHashTableHashJitRundown;
