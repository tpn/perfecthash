        title "Perfect Hash RawDog Mulshrolate1RX16 Index32x8 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RX16Index32x8_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate1RX Index32x8() routine for 16-bit
...
;
; VOID
; PerfectHashJitIndexMulshrolate1RX16Index32x8_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RX16Index32x8_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RX16Index32x8_x64, _TEXT$00
