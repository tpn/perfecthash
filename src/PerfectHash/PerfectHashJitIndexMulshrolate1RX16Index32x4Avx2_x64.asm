        title "Perfect Hash RawDog Mulshrolate1RX16 Index32x4 Avx2 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RX16Index32x4Avx2_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate1RX Index32x4() routine for 16-bit
;   assigned tables using AVX2 as a position-independent blob suitable for
;   RawDog JIT patching.
;
;--
...
;
; VOID
; PerfectHashJitIndexMulshrolate1RX16Index32x4Avx2_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
; Routine Description:
;
;   This routine implements the Mulshrolate1RX index functionality for four
;   keys against 16-bit assigned table data using AVX2.  It is designed to be
;   patched in-place by replacing the sentinel values embedded in the
;   instruction stream.
;
; Arguments:
;
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RX16Index32x4Avx2_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RX16Index32x4Avx2_x64, _TEXT$00
