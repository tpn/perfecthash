        title "Perfect Hash RawDog Mulshrolate1RX16 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RX16_x64.asm
;
; Abstract:
;
...
;
; ULONG
; PerfectHashJitIndexMulshrolate1RX16_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RX16_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RX16_x64, _TEXT$00
