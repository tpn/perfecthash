        title "Perfect Hash RawDog MultiplyShiftRX16 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRX16_x64.asm
;
; Abstract:
;
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRX16_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRX16_x64, _TEXT$00
