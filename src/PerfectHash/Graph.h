...
C_ASSERT(NUM_ASSIGNED_PER_PAGE       <= USHRT_MAX);
C_ASSERT(NUM_ASSIGNED_PER_LARGE_PAGE <= ULONG_MAX);
C_ASSERT(NUM_ASSIGNED_PER_CACHE_LINE <= UCHAR_MAX);
C_ASSERT(NUM_CACHE_LINES_PER_PAGE    <= USHRT_MAX);
...
C_ASSERT(NUM_ASSIGNED16_PER_PAGE       <= USHRT_MAX);
C_ASSERT(NUM_ASSIGNED16_PER_LARGE_PAGE <= ULONG_MAX);
C_ASSERT(NUM_ASSIGNED16_PER_CACHE_LINE <= UCHAR_MAX);
