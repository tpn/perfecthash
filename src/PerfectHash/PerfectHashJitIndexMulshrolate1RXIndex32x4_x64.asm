        title "Perfect Hash RawDog Mulshrolate1RX Index32x4 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RXIndex32x4_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate1RX Index32x4() routine as a
...
;
; VOID
; PerfectHashJitIndexMulshrolate1RXIndex32x4_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RXIndex32x4_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RXIndex32x4_x64, _TEXT$00
