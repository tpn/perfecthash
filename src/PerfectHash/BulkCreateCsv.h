...
#define BULK_CREATE_CSV_ROW_TABLE(FIRST_ENTRY, ENTRY, LAST_ENTRY)                                    \
    ...
    ENTRY(HashAllKeysFirst,                                                                          \
          ...
          OUTPUT_CHR)                                                                                \
                                                                                                     \
    ENTRY(DisableWriteCombineForVertexPairs,                                                         \
          (TableCreateFlags.DisableWriteCombineForVertexPairs != FALSE ? 'Y' : 'N'),                 \
          OUTPUT_CHR)                                                                                \
                                                                                                     \
    ENTRY(DisableWriteCombineRemovalAfterSuccessfulHashKeys,                                         \
          (TableCreateFlags.DisableWriteCombineRemovalAfterSuccessfulHashKeys != FALSE ? 'Y' : 'N'), \
          OUTPUT_CHR)                                                                                \
                                                                                                     \
