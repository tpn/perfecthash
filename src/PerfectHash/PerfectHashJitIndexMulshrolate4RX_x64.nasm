...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate4RX_x64.nasm
;
; Abstract:
;
;   This module implements the Mulshrolate4RX Index() routine as a position-
...
;--
        ...
        global PerfectHashJitIndexMulshrolate4RX_x64

;+++
;
; ULONG
; PerfectHashJitIndexMulshrolate4RX_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
;
;   This routine implements the Mulshrolate4RX index functionality.  It is
