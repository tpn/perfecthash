        title "Perfect Hash RawDog Mulshrolate3RX16 Avx512 v1 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate3RX16Avx512_v1_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate3RX Index32x16() routine for 16-bit
...
;
; VOID
; PerfectHashJitIndexMulshrolate3RX16Avx512_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
; Routine Description:
;
;   This routine implements the Mulshrolate3RX index functionality for sixteen
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate3RX16Avx512_x64, _TEXT$00, NoPad
        ...
        vpmulld zmm3, zmm3, zmm5                   ; Vertex1 *= Seed4.
        ...
        LEAF_END PerfectHashJitIndexMulshrolate3RX16Avx512_x64, _TEXT$00
