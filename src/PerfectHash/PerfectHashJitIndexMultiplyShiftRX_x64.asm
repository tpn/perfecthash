        title "Perfect Hash RawDog MultiplyShiftRX x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRX_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftRX Index() routine for 32-bit
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRX_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRX_x64, _TEXT$00
