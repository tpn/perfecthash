        title "Perfect Hash RawDog MultiplyShiftR Index32x4 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRIndex32x4_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftR Index32x4() routine as a
...
;
; VOID
; PerfectHashJitIndexMultiplyShiftRIndex32x4_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRIndex32x4_x64, _TEXT$00, NoPad
        ...
        movd    xmm1, eax
        pshufd  xmm1, xmm1, 0
        pand    xmm3, xmm1                         ; Mask vertex1.
        pand    xmm4, xmm1                         ; Mask vertex2.
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRIndex32x4_x64, _TEXT$00
