...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate3RX16Avx512_v2_x64.nasm
;
; Abstract:
;
...
;   suitable for RawDog JIT patching.  This variant uses register extracts
;   instead of gathers for Assigned loads.
;
;--
        ...
        global PerfectHashJitIndexMulshrolate3RX16Avx512_x64
...
; Routine Description:
;
;   This routine implements the Mulshrolate3RX Index32x16() functionality for
