...
// Module Name:
//
//   PerfectHashJitIndexMultiplyShiftR_arm64.s
//
// Abstract:
//
...
//--
        ...
        .globl PerfectHashJitIndexMultiplyShiftR_arm64

//+++
//
// ULONG
// PerfectHashJitIndexMultiplyShiftR_arm64(
//     _In_ ULONG Key
//     );
//
// Routine Description:
...
PerfectHashJitIndexMultiplyShiftR_arm64:
        ...
        lsrv    w2, w2, w3                    // Vertex2 >>= Seed3_Byte2.

        ldr     w5, RawDogHashMask
        and     w1, w1, w5                    // Mask vertex1.
        and     w2, w2, w5                    // Mask vertex2.
