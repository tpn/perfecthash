...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate2RX16_x64.nasm
;
; Abstract:
;
;   This module implements the Mulshrolate2RX Index() routine (16-bit assigned)
...
;--
        ...
        global PerfectHashJitIndexMulshrolate2RX16_x64
...
; Routine Description:
;
;   This routine implements the Mulshrolate2RX index functionality for tables
