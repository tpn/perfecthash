        title "Perfect Hash RawDog MultiplyShiftR16 Index32x16 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftR16Index32x16_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftR Index32x16() routine for 16-bit
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftR16Index32x16_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftR16Index32x16_x64, _TEXT$00
