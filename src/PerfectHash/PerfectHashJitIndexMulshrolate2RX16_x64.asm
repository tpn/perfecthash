        title "Perfect Hash RawDog Mulshrolate2RX16 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate2RX16_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate2RX Index() routine for 16-bit
...
;
; ULONG
; PerfectHashJitIndexMulshrolate2RX16_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
;
;   This routine implements the Mulshrolate2RX index functionality against
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate2RX16_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate2RX16_x64, _TEXT$00
