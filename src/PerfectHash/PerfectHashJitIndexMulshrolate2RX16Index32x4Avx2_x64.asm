        title "Perfect Hash RawDog Mulshrolate2RX16 Index32x4 Avx2 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate2RX16Index32x4Avx2_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate2RX Index32x4() routine for 16-bit
...
; Routine Description:
;
;   This routine implements the Mulshrolate2RX index functionality for four
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate2RX16Index32x4Avx2_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate2RX16Index32x4Avx2_x64, _TEXT$00
