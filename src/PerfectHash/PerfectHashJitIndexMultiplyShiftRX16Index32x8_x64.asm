        title "Perfect Hash RawDog MultiplyShiftRX16 Index32x8 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRX16Index32x8_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftRX Index32x8() routine for 16-bit
...
;
; VOID
; PerfectHashJitIndexMultiplyShiftRX16Index32x8_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
; Routine Description:
;
;   This routine implements the MultiplyShiftRX index functionality for eight
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRX16Index32x8_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRX16Index32x8_x64, _TEXT$00
