        title "Perfect Hash RawDog MultiplyShiftR Index32x16 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMultiplyShiftRIndex32x16_x64.asm
;
; Abstract:
;
;   This module implements the MultiplyShiftR Index32x16() routine as a
...
;
; VOID
; PerfectHashJitIndexMultiplyShiftRIndex32x16_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
; Routine Description:
;
;   This routine implements the MultiplyShiftR index functionality for sixteen
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMultiplyShiftRIndex32x16_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMultiplyShiftRIndex32x16_x64, _TEXT$00
