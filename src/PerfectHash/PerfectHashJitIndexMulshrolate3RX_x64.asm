        title "Perfect Hash RawDog Mulshrolate3RX x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate3RX_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate3RX Index() routine for 32-bit
...
;
; ULONG
; PerfectHashJitIndexMulshrolate3RX_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate3RX_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate3RX_x64, _TEXT$00
