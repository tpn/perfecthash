...
#define ADD_PARAM_IF_EQUAL_AND_VALUE_IS_INT64(Name) \
    ...
    ADD_PARAM_IF_EQUAL_AND_VALUE_IS_INTEGER(MinAttempts);

    ADD_PARAM_IF_EQUAL_AND_VALUE_IS_INTEGER(MaxAttempts);

    ADD_PARAM_IF_EQUAL_AND_VALUE_IS_INTEGER(FixedAttempts);

    ADD_PARAM_IF_EQUAL_AND_VALUE_IS_INTEGER(TargetNumberOfSolutions);
