    ...
    )
{
    ...
    DECL_ARG(DisableWriteCombineForVertexPairs);
    DECL_ARG(DisableWriteCombineRemovalAfterSuccessfulHashKeys);
    ...
    SET_FLAG_AND_RETURN_IF_EQUAL(DisableWriteCombineForVertexPairs);
    SET_FLAG_AND_RETURN_IF_EQUAL(DisableWriteCombineRemovalAfterSuccessfulHashKeys);
