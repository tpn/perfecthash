...
Abstract:
    ...
    benchmark index exe C source file as part of the CHM v1 algorithm
    implementation for the perfect hash library.

--*/

#include "stdafx.h"
#include "CompiledPerfectHashTableBenchmarkIndexExe_CSource_RawCString.h"

_Use_decl_annotations_
HRESULT
PrepareCSourceBenchmarkIndexExeFileChm01(
