        title "Perfect Hash RawDog Mulshrolate1RX16 Index32x4 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate1RX16Index32x4_x64.asm
;
; Abstract:
;
...
;
; VOID
; PerfectHashJitIndexMulshrolate1RX16Index32x4_x64(
;     _In_ ULONG Key1,
;     _In_ ULONG Key2,
;     _In_ ULONG Key3,
;     _In_ ULONG Key4,
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate1RX16Index32x4_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate1RX16Index32x4_x64, _TEXT$00
