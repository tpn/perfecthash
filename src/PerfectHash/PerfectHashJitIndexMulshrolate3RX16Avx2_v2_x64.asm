        title "Perfect Hash RawDog Mulshrolate3RX16 Avx2 v2 x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate3RX16Avx2_v2_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate3RX Index32x8() routine for 16-bit
...
; Routine Description:
;
;   This routine implements the Mulshrolate3RX index functionality for eight
;   keys using AVX2 instructions and 16-bit assigned table data.  It is
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate3RX16Avx2_x64, _TEXT$00, NoPad
        ...
        mov     rax, 0B2B2B2B2B2B2B2B2h             ; Seed4.
        vmovd   xmm5, eax
        ...
        vpor    ymm3, ymm0, ymm1
        vpmulld ymm3, ymm3, ymm5                   ; Vertex1 *= Seed4.
        ...
        LEAF_END PerfectHashJitIndexMulshrolate3RX16Avx2_x64, _TEXT$00
