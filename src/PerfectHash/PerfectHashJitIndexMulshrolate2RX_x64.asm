        title "Perfect Hash RawDog Mulshrolate2RX x64"
...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate2RX_x64.asm
;
; Abstract:
;
;   This module implements the Mulshrolate2RX Index() routine for 32-bit
...
;
; ULONG
; PerfectHashJitIndexMulshrolate2RX_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
...
;--
        ...
        LEAF_ENTRY PerfectHashJitIndexMulshrolate2RX_x64, _TEXT$00, NoPad
        ...
        LEAF_END PerfectHashJitIndexMulshrolate2RX_x64, _TEXT$00
