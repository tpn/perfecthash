...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate2RX16Avx2_v2_x64.nasm
;
; Abstract:
;
...
PerfectHashJitIndexMulshrolate2RX16Avx2_x64:
        ...
        vmovdqu [rsp + 0x40], ymm3            ; Store vertex1 indices.
        vmovdqu [rsp + 0x60], ymm4            ; Store vertex2 indices.
