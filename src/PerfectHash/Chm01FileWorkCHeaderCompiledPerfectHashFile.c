...
Abstract:
    ...
    CompiledPerfectHash.h C header file as part of the CHM v1 algorithm
    implementation for the perfect hash library.

--*/

#include "stdafx.h"
#include "CompiledPerfectHash_CHeader_RawCString.h"

_Use_decl_annotations_
HRESULT
PrepareCHeaderCompiledPerfectHashFileChm01(
