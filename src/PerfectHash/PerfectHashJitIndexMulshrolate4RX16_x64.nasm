...
; Module Name:
;
;   PerfectHashJitIndexMulshrolate4RX16_x64.nasm
;
; Abstract:
;
;   This module implements the Mulshrolate4RX Index() routine (16-bit assigned)
...
;--
        ...
        global PerfectHashJitIndexMulshrolate4RX16_x64

;+++
;
; ULONG
; PerfectHashJitIndexMulshrolate4RX16_x64(
;     _In_ ULONG Key
;     );
;
; Routine Description:
;
;   This routine implements the Mulshrolate4RX index functionality for tables
...
PerfectHashJitIndexMulshrolate4RX16_x64:
        ...
        imul    edx, dword [rel RawDogSeed5]   ; Vertex2 *= Seed5.
        mov     ecx, r11d
