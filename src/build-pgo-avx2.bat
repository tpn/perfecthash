...
msbuild /nologo /m /t:Build /p:Configuration=PGInstrument;Platform=x64;InstructionSet=AdvancedVectorExtensions2 PerfectHash.sln
...
msbuild /nologo /m /t:Build /p:Configuration=PGOptimize;Platform=x64;InstructionSet=AdvancedVectorExtensions2 PerfectHash.sln
