...
msbuild /nologo /m /t:Build /p:Configuration=PGInstrument;Platform=x64;HookPenter=1 PerfectHash.sln
...
msbuild /nologo /m /t:Build /p:Configuration=PGOptimize;Platform=x64;HookPenter=1 PerfectHash.sln
