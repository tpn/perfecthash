...
msbuild /nologo /m /t:Build /p:Configuration=PGInstrument;Platform=x64;InstructionSet=AdvancedVectorExtensions512 PerfectHash.sln
...
..\bin\timemem.exe .\x64\PGInstrument\PerfectHashBulkCreate.exe c:\src\perfecthash-keys\hard c:\temp\ph.pgi Chm01 RotateMultiplyXorRotate2 And 3 --AttemptsBeforeTableResize=10000 --MaxNumberOfTableResizes=0 --FindBestGraph --BestCoverageAttempts=2 --BestCoverageType=HighestScore --MainWorkThreadpoolPriority=Low
...
msbuild /nologo /m /t:Build /p:Configuration=PGOptimize;Platform=x64;InstructionSet=AdvancedVectorExtensions512 PerfectHash.sln
